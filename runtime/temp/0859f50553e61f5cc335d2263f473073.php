<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"D:\phpStudy\WWW\1228\public/../application/admin\view\article\edit.html";i:1516095658;s:60:"D:\phpStudy\WWW\1228\application\admin\view\common\head.html";i:1516082504;s:60:"D:\phpStudy\WWW\1228\application\admin\view\common\foot.html";i:1514618874;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                        ...
                        <div id="horizontal-form">
                            <form class="form-horizontal" enctype="multipart/form-data" id="formArticle" role="form" action="" method="post"  >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control"  placeholder="" name="title" value="<?php echo $article['title']; ?>" type="text">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control"  placeholder="" name="keywords"  value="<?php echo $article['keywords']; ?>" type="text">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control" name="c_id">
                                            ...
                                            <option value="<?php echo $cate['id']; ?>" <?php if($article["c_id"] == $cate["id"]): ?> selected='selected' <?php endif; ?> ><?php if($cate['level'] != 0): ?>|<?php endif;  echo  str_repeat('----',$cate['level'])  ?> <?php echo $cate['catename']; ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <input class="form-control"  placeholder="" name="author" value="<?php echo $article['author']; ?>" required="" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="click" class="col-sm-2 control-label no-padding-right">点击数</label>
                                    <div class="col-sm-3">
                                        <input class="form-control"  placeholder="" name="click" value="<?php echo $article['click']; ?>" required="" type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="zan" class="col-sm-2 control-label no-padding-right">点赞数</label>
                                    <div class="col-sm-3">
                                        <input class="form-control"  placeholder="" name="zan" value="<?php echo $article['zan']; ?>" required="" type="text">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3" style="line-height: 30px;">
                                        <?php if($article["image"] != ""): ?>
                                            <img width="50" height="30" src="<?php echo $article['image']; ?>" onclick="bigImg(this.src)" title="点击查看大图" />
                                        <?php else: ?>
                                        暂无图片
                                        <?php endif; ?>
                                    </div>
...
<script type="text/javascript">
    $(function() {
        $("#btnSub").click(function () {
            sendAjaxForm("formArticle",'<?php echo url("edit"); ?>','<?php echo url("lst"); ?>');
        })
    })
