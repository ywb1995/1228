<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpStudy\WWW\1228\public/../application/admin\view\auth_group\edit.html";i:1516728292;s:60:"D:\phpStudy\WWW\1228\application\admin\view\common\head.html";i:1516426479;s:60:"D:\phpStudy\WWW\1228\application\admin\view\common\foot.html";i:1514618874;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                        ...
                        <div id="horizontal-form">
                            <form class="form-horizontal" enctype="multipart/form-data" id="formArticle" role="form" action="" method="post"  >
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control"  placeholder="" name="title" value="<?php echo $authGroup['title']; ?>" required="" type="text">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="help-block col-sm-4 red">
                                            <label>
                                                <input class="checkbox-slider colored-darkorange" name="status" value="1" <?php if($authGroup['status'] == 1): ?>checked="checked" <?php endif; ?> type="checkbox">
                                                ...
                                                <td>
                                                    <div class="checkbox">
                                                        <label><?php   echo str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;',$level) ?>
                                                            <input type="checkbox" dataid="id-<?php echo $rule['dataid']; ?>" class="inverted checkbox-parent <?php if($rule['level'] != 0): ?> checkbox-child <?php endif; ?> " name="rules[]" <?php if(is_array($authGroup['rules']) || $authGroup['rules'] instanceof \think\Collection || $authGroup['rules'] instanceof \think\Paginator): if( count($authGroup['rules'])==0 ) : echo "" ;else: foreach($authGroup['rules'] as $key=>$groupRule): if($groupRule == $rule['id']): ?> checked='checked' <?php endif; endforeach; endif; else: echo "" ;endif; ?>value="<?php echo $rule['id']; ?>" >
                                                            <span class="text">
                                                    <?php echo $rule['title']; ?></span>
                                                        </label>
                                                    </div>
