<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpStudy\WWW\1228\public/../application/admin\view\auth_rule\lst.html";i:1516728361;s:60:"D:\phpStudy\WWW\1228\application\admin\view\common\head.html";i:1516426479;s:60:"D:\phpStudy\WWW\1228\application\admin\view\common\foot.html";i:1514618874;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left"><?php if($rule['level'] != 0) echo '|'; echo str_repeat('----',$rule['level'])  ?><?php echo $rule['title']; ?></td>
                                            <td align="center"><?php echo $rule['name']; ?></td>
                                            <td align="center">
                                                <a href="<?php echo url('edit',['id'=>$rule['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="<?php echo url('delete',['id'=>$rule['id']]); ?>" onClick="warning('确实要删除吗', '/admin/user/del/id/6.html')" class="btn btn-danger btn-sm shiny">
