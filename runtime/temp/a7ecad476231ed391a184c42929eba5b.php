<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\phpStudy\WWW\1228\public/../application/admin\view\user\lst.html";i:1516724387;s:60:"D:\phpStudy\WWW\1228\application\admin\view\common\head.html";i:1516426479;s:60:"D:\phpStudy\WWW\1228\application\admin\view\common\foot.html";i:1514618874;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center"><?php $count = count($user['AuthGroup']); foreach($user['AuthGroup'] as $k=>$groupName){ echo $groupName['title']; if($k != ($count-1)) echo "，";} ?></td>
                                            <td align="center">
                                                <a href="<?php echo url('edit',['id'=>$user['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                                    <i class="fa fa-edit"></i> 编辑
                                                </a>
                                                <a href="<?php echo url('delete',['id'=>$user['id']]); ?>" onClick="warning('确实要删除吗', '/admin/user/del/id/6.html')" class="btn btn-danger btn-sm shiny">
